...
public class mytest {
    ...
    public void AppiumTest() throws MalformedURLException {
        ...
        AppiumDriverLocalService service = new AppiumServiceBuilder().withAppiumJS(new File("//Users//muhammad.faiz//.nvm//versions//node//v14.19.1//lib//node_modules//appium//build//lib//main.js")).withIPAddress("127.0.0.1").usingPort(4723).build();
        service.start();
